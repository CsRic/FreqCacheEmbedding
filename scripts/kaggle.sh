...
#    --learning_rate 1. --batch_size 16384 --use_sparse_embed_grad --use_cache --use_freq --use_tablewise \
#     --profile_dir "tensorboard_log/kaggle/w2_p1_16k"  --buffer_size 0 --use_overlap --cache_sets 337625
#

torchx run -s local_cwd -cfg log_dir=log/kaggle/w3_p1_16k dist.ddp -j 1x3 --script recsys/dlrm_main.py -- \
    --dataset_dir /data/scratch/RecSys/criteo_kaggle_data/ --pin_memory --shuffle_batches \
    --learning_rate 1. --batch_size 16384 --use_sparse_embed_grad --use_cache --use_freq --use_tablewise \
     --profile_dir "tensorboard_log/kaggle/w2_p1_16k"  --buffer_size 0 --use_overlap --cache_sets 337625
...
#     --dataset_dir /data/scratch/RecSys/criteo_kaggle_data/ --pin_memory --shuffle_batches \
#     --learning_rate 5e-1 --batch_size 16384 --use_sparse_embed_grad --use_cache --use_freq --use_tablewise \
