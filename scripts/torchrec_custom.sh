...
mkdir -p logs
for PREFETCH_NUM in 1 4 8 16 32
do
for GPUNUM in 1 # 1 # 2
do
for BATCHSIZE in 1024 # 512 1024 2048 4096 #8192 512 ##16384 8192 4096 2048 1024 512     
do
for SHARDTYPE in  "table"
do
for KERNELTYPE in "colossalai" # "uvm_lfu" # "colossalai" # "uvm_lfu" # "colossalai" "fused"
do
# For TorchRec baseline
set_n_least_used_CUDA_VISIBLE_DEVICES ${GPUNUM}
export PLAN=g${GPUNUM}_bs_${BATCHSIZE}_${SHARDTYPE}_pf_${PREFETCH_NUM}_eb_${EMB_DIM}_custom_${KERNELTYPE}
